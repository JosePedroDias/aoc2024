...
private val WORD2 = listOf('M', 'A', 'S')

private typealias CharMatrix = Array<CharArray>

private fun fillMatrix(input: List<String>): CharMatrix {
...
private fun matrixToString(m: CharMatrix): String {
    val W = m[0].size
    val H = m.size
...
private fun fillMatrix(m: CharMatrix, f: (x: Int, y: Int) -> Char): CharMatrix {
    val W = m[0].size
    val H = m.size
...
private fun part2(input: List<String>, debug: Boolean): Int {
...
private fun part1(input: List<String>, debug: Boolean): Int {
    val m = fillMatrix(input)
    val W = m[0].size
    val H = m.size
    val WS = WORD.size
